...
[assembly: ModuleType("TwoFactor", typeof(enova365.TwoFactorAuth.TwoFactorModule), 3, "TwoFactor", 1, VersionNumber=3)]
...
namespace enova365.TwoFactorAuth {
	...
	[System.CodeDom.Compiler.GeneratedCode("Soneta.Generator", "3")]
	public partial class TwoFactorModule : Module {
		...
		public sealed class SecretRecord : Record {
			...
			public override void Load(RowCreator creator, int delta) {
				...
				Operator = creator.Load_Row(1, "Operators");
				SharedSecret = creator.Load_string(2);
			}
		}
